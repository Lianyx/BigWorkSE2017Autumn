...
public class PaymentReceiptListPane extends ReceiptListPane<PaymentReceiptListVO> {
    ...
    public PaymentReceiptListPane(boolean isSell) throws Exception {
    ...
    public void refresh(boolean toSwitch) {
        ...
        try {
            ...
            Predicate<Integer> p = (s) -> {
                if ((set = paymentBillReceiptblService.search(billReceiptSearchVO, isSell.get())) != null) {
                    System.out.println(set.size());
                    return true;
                }
                return false;
            };
            GetTask<HashSet<PaymentReceiptListVO>, PaymentBillReceiptblService> getTask =
                    new GetTask<>(() -> {
