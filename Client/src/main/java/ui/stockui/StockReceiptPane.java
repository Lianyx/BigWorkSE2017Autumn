...
public class StockReceiptPane extends ReceiptDetailPane<StockReceiptVO> {
    ...
    public void refresh(boolean toSwitch) {
        ...
        try{
            ...
            Predicate<Integer> p = (i)->{if((vo = stockblService.showDetail(receiptid))!=null) return true;return false;};
            GetTask<StockReceiptVO,StockblService> task =
                    new GetTask<>(()-> {
