...
public class SalesDataService_Driver {
    public static void main(String[] args) {
        ...
        System.out.println(salesDataService.insert(new SalesReceiptPO("00001", "00002", "²Ö¿â¼×")));
        System.out.println(salesDataService.update(new SalesReceiptPO("00001", "00002", "²Ö¿â¼×")));
