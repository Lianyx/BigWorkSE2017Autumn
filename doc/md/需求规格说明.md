...
优先级＝高  
###&emsp;3.2.20.2 刺激/响应序列
&emsp;刺激：财务人员选择期初建账  
&emsp;响应：系统要求输入所有信息  
&emsp;刺激：财务人员输入信息  
&emsp;响应：系统保存，并将此信息作为系统的启动初始状态  
###&emsp;3.2.20.3 相关功能需求
|.||
|---|---|
...
### 3.3.2 可维护性
Modifiability1：系统网络发生故障时，能够在0.5个人天内进行修复完成    
Modifiability2：某数据格式发生变化时，能够再0.5个人天内修复完成  
### 3.3.3 易用性
