...
public class ChargeBillReceiptPO extends ReceiptPO {
    ...
    public ChargeBillReceiptPO(int dayId, int operatorId, LocalDateTime createTime, LocalDateTime lastModifiedTime, ReceiptState receiptState, int clientId, TransferItemPO[] transferList, double sum) {
